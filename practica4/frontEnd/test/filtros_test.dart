...
void main() {
  group("Grupo para comprobar Productos: ", () {
    ...
    test("Prueba de Adquirir Producto", () async{
      cesta.adquirirProducto(productos[0]);
      expect(cesta.productos.contains(productos[0]), true);
    });

    test("Prueba de Eliminar Producto", () async {
      expect(productos, isNotNull);
      expect(productos.length, 3);
      ...
      expect(cesta.productos.contains(productos[0]), false);
      expect(cesta.productos.contains(productos[1]), true);
    });

    

    test("Prueba de Precio Total", () async {
      cesta.adquirirProducto(productos[0]);
      expect(cesta.precioTotal(), 10);
    });

    test("Prueba de Calcular Cantidad Producto", () async {
      cesta.adquirirProducto(productos[0]);
      cesta.adquirirProducto(productos[0]);
      cesta.adquirirProducto(productos[0]);
    ...
    test("Prueba de eliminar ocurrencias", () async {
      cesta.adquirirProducto(productos[0]);
      cesta.adquirirProducto(productos[0]);
      cesta.adquirirProducto(productos[0]);
      cesta.eliminarOcurrencias(productos[0]);
      expect(cesta.productosOriginales, []);
    });
  });
  ...
  group("Grupo para comprobar Filtros: ", () {
    ...
    test("Prueba de inicialización de gestor filtros", () async {
    ...
    test("Prueba de Precio Máximo", () async {
    ...
    test("Prueba de Precio Mínimo", () async {
    ...
    test("Prueba de En Oferta", () async {
    ...
    test("Prueba de Por Categoria", () async {
    ...
    test("Prueba con varios filtros", () async {
